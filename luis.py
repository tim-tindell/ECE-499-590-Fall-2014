...
#<PHASE 7> Put the right leg down more forward then before
        ...
        time.sleep(5)
        print "Phase 7 fin"
#<PHASE 8> move the hips to move the center of gravity to the left foot    
        setGoal(myActuators,LHR,0)
        setGoal(myActuators,RHR,0)
        setGoal(myActuators,RAR,0)
        setGoal(myActuators,LAR,0)
...
#<PHASE 8> move the hips to move the center of gravity to the left foot    
        ...
        time.sleep(3)
        print "Phase 8 fin"
#<PHASE 9> Move the right leg into the air
        amount=0.42;
        while(amount<=.72):
        ...
        time.sleep(2)
        print "Phase 9 fin"
#<PHASE 10> Put the right leg down more forward then before
